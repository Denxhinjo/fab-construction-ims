      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl shadow-2xl overflow-hidden">
          ...
          <div className="bg-gradient-to-r from-brand-500 to-brand-600 px-8 py-10 text-center">
            ...
            <h1 className="text-2xl font-bold text-white">Fab Construction</h1>
            <p className="text-brand-100 text-sm mt-1">Inventory Management System</p>
          </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    type="text"
                    placeholder="admin@fabconstruction.com"
        ...
        <p className="text-center text-slate-500 text-xs mt-6">
          © 2024 Fab Construction. All rights reserved.
        </p>
      </div>
    </div>
  )
